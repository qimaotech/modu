...
- **Child ticket**: an issue linked to the map as a GitHub sub-issue. Where sub-issues aren't enabled, add it to the map task list and put `Part of #<map>` at the top of the child.
